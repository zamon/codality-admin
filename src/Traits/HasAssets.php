...
trait HasAssets
{
     ...
     * @var string
     */
    public static $manifest = 'vendor/codality-admin/minify-manifest.json';
     ...
     */
    public static $min = [
        'js'  => 'vendor/codality-admin/codality-admin.min.js',
        'css' => 'vendor/codality-admin/codality-admin.min.css',
    ];
    ...
    public static $baseCss = [
        // first libraries
        'vendor/codality-admin/nprogress/nprogress.css',
        'vendor/codality-admin/sweetalert2/sweetalert2.min.css',
        'vendor/codality-admin/toastify-js/toastify.css',
        'vendor/codality-admin/flatpickr/flatpicker-custom.css',
        'vendor/codality-admin/choicesjs/styles/choices.min.css',
        'vendor/codality-admin/sortablejs/nestable.css',

        // custom open admin stuff
        // generated through sass
        'vendor/codality-admin/codality-admin/css/styles.css',
    ];
    ...
    public static $baseJs = [
        'vendor/codality-admin/bootstrap5/bootstrap.bundle.min.js',
        'vendor/codality-admin/nprogress/nprogress.js',
        'vendor/codality-admin/axios/axios.min.js',
        'vendor/codality-admin/sweetalert2/sweetalert2.min.js',
        'vendor/codality-admin/toastify-js/toastify.js',
        'vendor/codality-admin/flatpickr/flatpickr.min.js',
        'vendor/codality-admin/choicesjs/scripts/choices.min.js',
        'vendor/codality-admin/sortablejs/Sortable.min.js',

        'vendor/codality-admin/codality-admin/js/polyfills.js',
        'vendor/codality-admin/codality-admin/js/helpers.js',
        'vendor/codality-admin/codality-admin/js/codality-admin.js',
        'vendor/codality-admin/codality-admin/js/codality-admin-actions.js',
        'vendor/codality-admin/codality-admin/js/codality-admin-grid.js',
        'vendor/codality-admin/codality-admin/js/codality-admin-grid-inline-edit.js',
        'vendor/codality-admin/codality-admin/js/codality-admin-form.js',
        'vendor/codality-admin/codality-admin/js/codality-admin-toastr.js',
        'vendor/codality-admin/codality-admin/js/codality-admin-resource.js',
        'vendor/codality-admin/codality-admin/js/codality-admin-tree.js',
        'vendor/codality-admin/codality-admin/js/codality-admin-selectable.js',
    ...
    public static function baseCss($css = null, $minify = true)
    {
        ...
        //array_unshift(static::$baseCss, "vendor/codality-admin/AdminLTE/dist/css/skins/{$skin}.min.css");
