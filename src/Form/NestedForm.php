...
namespace CodalityAdmin\Admin\Form;
...
use CodalityAdmin\Admin\Widgets\Form as WidgetForm;
...
class NestedForm
{
    ...
    /**
     * @var \CodalityAdmin\Admin\Form|\CodalityAdmin\Admin\Widgets\Form
     */
    protected $form;
    ...
    protected function prepareRecord($record)
    {
        ...
        foreach ($this->fields as $field) {
            ...
            if (($field instanceof \CodalityAdmin\Admin\Form\Field\Hidden) || $value != $field->original() || ($this->save_null_values && $value == null)) {
                if (is_array($columns)) {
