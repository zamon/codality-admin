...
namespace CodalityAdmin\Admin\Form\Field\Traits;
...
trait HasMediaPicker
{
    ...
    {
        if (!class_exists("CodalityAdmin\Admin\Media\MediaManager")) {
            throw new \Exception(
                '[Media Manager extention not installed yet.<br> Install using: <b>composer require codality-admin-ext/media-manager</b><br><br>'
            );
        }
