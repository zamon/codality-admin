...
class Map extends Field
{
    ...
    public static function getAssets()
    {
        switch (config('admin.map_provider')) {
            ...
            case 'openstreetmaps':
            default:
                $css = ['/vendor/codality-admin/leaflet/leaflet.css', '/vendor/codality-admin/leaflet/leaflet-geosearch.css'];
                $js = ['/vendor/codality-admin/leaflet/leaflet.js', '/vendor/codality-admin/leaflet/leaflet-geosearch.js'];
        }
