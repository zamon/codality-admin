...
use CodalityAdmin\Admin\Form\Field\Traits\HasMediaPicker;
use CodalityAdmin\Admin\Form\Field\Traits\UploadField;
...
class File extends Field
{
    ...
    protected static $css = [
        '/vendor/codality-admin/fields/file-upload/file-upload.css',
    ];

    protected static $js = [
        '/vendor/codality-admin/fields/file-upload/file-upload.js',
    ];
