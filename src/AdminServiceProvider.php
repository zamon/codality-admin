...
class AdminServiceProvider extends ServiceProvider
{
    ...
    protected function registerPublishing()
    {
        if ($this->app->runningInConsole()) {
            $this->publishes([__DIR__.'/../config' => config_path()], 'codality-admin-config');
            $this->publishes([__DIR__.'/../resources/lang' => resource_path('lang')], 'codality-admin-lang');
            $this->publishes([__DIR__.'/../database/migrations' => database_path('migrations')], 'codality-admin-migrations');
            $this->publishes([__DIR__.'/../resources/assets' => public_path('vendor/codality-admin')], 'codality-admin-assets');
            $this->publishes([__DIR__.'/../resources/assets/test' => public_path('vendor/codality-admin-test')], 'codality-admin-test');
        }
    }
    ...
    public function bladeDirectives()
    {
        Blade::directive('box', function ($title) {
            return "<?php \$box = new \CodalityAdmin\Admin\Widgets\Box({$title}, '";
        });
