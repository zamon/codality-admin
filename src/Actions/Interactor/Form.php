...
namespace CodalityAdmin\Admin\Actions\Interactor;
...
use CodalityAdmin\Admin\Form as ModalForm;
...
class Form extends Interactor
{
    ...
    {
        if ($this->extendsFrom($this->action, 'CodalityAdmin\Admin\Actions\RowAction')) {
    ...
    protected function checkUploadFiel($field)
    {
        ...
        if ($this->extendsFrom($field, 'CodalityAdmin\Admin\Form\Field\File')) {
            $this->multipart = true;
        }
    }
