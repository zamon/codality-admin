...
namespace CodalityAdmin\Admin\Facades;
 ...
 * Class Admin.
 *
 * @method static \CodalityAdmin\Admin\Grid                                                     grid($model, \Closure $callable)
 * @method static \CodalityAdmin\Admin\Form                                                     form($model, \Closure $callable)
 * @method static \CodalityAdmin\Admin\Show                                                     show($model, $callable = null)
 * @method static \CodalityAdmin\Admin\Tree                                                     tree($model, \Closure $callable = null)
 * @method static \CodalityAdmin\Admin\Layout\Content                                           content(\Closure $callable = null)
 ...
 *
 * @see \CodalityAdmin\Admin\Admin
 */
class Admin extends Facade
{
    protected static function getFacadeAccessor()
    {
        return \CodalityAdmin\Admin\Admin::class;
    }
}
