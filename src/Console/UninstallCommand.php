...
class UninstallCommand extends Command
{
    ...
    {
        if (!$this->confirm('Are you sure to uninstall codality-admin?')) {
            return;
        }

        $this->removeFilesAndDirectories();

        $this->line('<info>Uninstalling codality-admin!</info>');
    }
    ...
    protected function removeFilesAndDirectories()
    {
        ...
        $this->laravel['files']->deleteDirectory(public_path('vendor/codality-admin/'));
