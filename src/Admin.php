...
use CodalityAdmin\Admin\Controllers\AuthController;
use CodalityAdmin\Admin\Layout\Content;
use CodalityAdmin\Admin\Traits\HasAssets;
use CodalityAdmin\Admin\Widgets\Navbar;
...
class Admin
{
     ...
     *
     * @return \CodalityAdmin\Admin\Grid
     *
     ...
     * @param Closure $callable
     *
     * @return \CodalityAdmin\Admin\Form
     *
     *  @deprecated since v1.6.1
     */
     ...
     *
     * @return \CodalityAdmin\Admin\Tree
     */
     ...
     * @param Closure $callable
     *
     * @return \CodalityAdmin\Admin\Layout\Content
     */
     ...
     * Get navbar object.
     *
     * @return \CodalityAdmin\Admin\Widgets\Navbar
     */
    ...
    /**
     * Register the codality-admin builtin routes.
     *
     * @return void
     *
    ...
    public function routes()
    {
        ...
        app('router')->group($attributes, function ($router) {
            ...
            $router->namespace('\CodalityAdmin\Admin\Controllers')->group(function ($router) {
    ...
    {
        return url('/vendor/codality-admin/'.$asset);
    }
